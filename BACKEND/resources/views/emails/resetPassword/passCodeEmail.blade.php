...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>Siendo las {{ now()->format('H:i:s')??'00:00' }}, se ha solicitado un código de <strong><i>reseteo de contraseña actual</i></strong> de su cuenta. Use el siguiente código para confirmar su petición:</p>
